...
public function PublicBookingForm( $apartment, $maxdays=14 ) {
	...
	$this-> setWidgets(array(
		...
		'pax' 		   => new sfWidgetFormSelect( array('choices' => range(1, $apartment->max_pax, 1) ), array('class'=>'span1') ),
		'days' 		   => new sfWidgetFormSelect( array( 'choices' => range(0, $maxdays, 1) ), array('class'=>'span1') ),
